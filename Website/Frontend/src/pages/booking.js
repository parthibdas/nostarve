  ...
  <div className="d-flex-justify-content-around" data-aos="zoom-in-up"  >
    ...
    <Card style={{ width: '23rem' }} >
      ...
      <Card.Body>
        ...
        <div className='click'><Button onClick={onOpenModal} variant="primary">Donate Food</Button></div>
      </Card.Body>
    </Card>
    </div>
    <div className="bok">
    ...
    <Card style={{ width: '23rem' }} >
      ...
      <Card.Body>
        ...
        <Card.Text>
          Serve your excess food to the hungry people on weekly basis. Your excess food can save a life.<br></br><br></br><br></br><br></br>
          <span style={{ fontWeight: 'bold' }}>Click here to donate your food!</span>
        </Card.Text>
        <div className='click' ><Button onClick={onOpenModal} variant="primary">Donate Food</Button></div>
      </Card.Body>
